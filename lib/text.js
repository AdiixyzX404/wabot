...
const mess = {
			 ...
			 admin: 'hanya admin yang dapat menggunakan perintah ini!',
			 botAdmin: 'Aku bukan admin T_T',
			 limit: 'Limit penggunaan kakak sudah habis\n\nNote: limit akan direset setiap 00.00',
			 ownerOnly: 'Hanya owner yang bisa menggunakan perintah ini!',
			lockF: 'Fitur tersebut di lock oleh owner'
}
